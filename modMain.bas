...
Private Sub Main()
   ...
   If Len(Command$()) > 0 Then
      If InStr(1, VBA.LCase(Split(Command$, " ")(0)), "runas") <> 0 Then
         'InitCommonControls
         frmMain.show
      End If
   Else
   ...
   End If
End Sub
Public Sub CreateRoundRectFromWindow(ByRef oWindow As Object, Optional ByVal w As Long = 10)
   On Error Resume Next
   Dim lRight  As Long
   Dim lBottom As Long
   Dim hRgn    As Long
   With oWindow
      ...
      hRgn = CreateRoundRectRgn(0, 0, lRight, lBottom, w, w)
